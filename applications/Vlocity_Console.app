...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    <consoleConfig>
        <componentList>
            ...
            <components>InteractionLauncher</components>
        </componentList>
        <detailPageRefreshMethod>autoRefresh</detailPageRefreshMethod>
        <footerColor>#ED7932</footerColor>
        <headerColor>#16325C</headerColor>
        <keyboardShortcuts>
            <defaultShortcuts>
        ...
        <liveAgentConfig>
            ...
            <pageNamesToOpen>VDOCTIRedirect</pageNamesToOpen>
            <showKnowledgeArticles>false</showKnowledgeArticles>
        </liveAgentConfig>
        <primaryTabColor>#ED7932</primaryTabColor>
    </consoleConfig>
    <defaultLandingTab>standard-home</defaultLandingTab>
    <description>Vlocity console application.</description>
    <isServiceCloudConsole>true</isServiceCloudConsole>
    <label>Vlocity Console</label>
    <logo>VDO_Demo_Documents/VDOConsoleLogo.png</logo>
    <preferences>
    ...
    <tabs>Agent_Home</tabs>
    <tabs>Agent_Dashboard</tabs>
